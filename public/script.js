...
navigator.mediaDevices
  ...
  .then((stream) => {
    ...
    /**
     * Instantiates the Hands gesture detection. Any files that hands recieves will be
     * retrieved from the provided CDN endpoint in the configs.
     * 
     * @const
     * @constructor
     * @param {Object} [configs] Configurations for setting up the Hands object, such as locateFile
     * @fires hands#setOptions
     * @fires hands#onResults
     */
